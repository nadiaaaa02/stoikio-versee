...
const PARTICLES = [
  ...
  { s: "H₂O",  l: 5,  t: 10, sz: 1.1, dur: 4.0, del: 0,   op: 1.0, anim: "floatA" },
  { s: "O₂",   l: 15, t: 75, sz: 0.9, dur: 3.2, del: 0.5, op: 1.0, anim: "floatB" },
  { s: "•",    l: 22, t: 30, sz: 1.4, dur: 2.5, del: 1.0, op: 1.0, anim: "floatC" },
  { s: "CO₂",  l: 30, t: 88, sz: 1.0, dur: 3.8, del: 0.3, op: 1.0, anim: "floatA" },
  { s: "N₂",   l: 40, t: 15, sz: 0.85,dur: 2.8, del: 1.5, op: 1.0, anim: "floatB" },
  { s: "⬡",   l: 48, t: 60, sz: 1.6, dur: 5.0, del: 0.8, op: 1.0, anim: "spinSlow"},
  { s: "H",    l: 55, t: 40, sz: 1.2, dur: 2.2, del: 0.2, op: 1.0, anim: "floatC" },
  { s: "NaCl", l: 63, t: 82, sz: 0.9, dur: 3.5, del: 1.2, op: 1.0, anim: "floatA" },
  { s: "•",    l: 70, t: 20, sz: 1.0, dur: 2.0, del: 0.7, op: 1.0, anim: "floatB" },
  { s: "CH₄",  l: 78, t: 65, sz: 1.0, dur: 4.2, del: 0.4, op: 1.0, anim: "floatC" },
  { s: "⬡",   l: 85, t: 35, sz: 1.8, dur: 6.0, del: 1.8, op: 1.0, anim: "spinSlow"},
